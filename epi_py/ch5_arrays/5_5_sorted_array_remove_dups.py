...
TRICK #4: SINGLE PASS. LOOP OVER "i" INDEX. THEN AT EACH STEP, CHECK IF: [write_index-1] == [i] ... I.E. NEED TO COMPARE THE 2 DIFFERENT POINTERS ... THIS ALLOWS WIDENING OF THE GAP FOR COMPARISON.
